...
export default function Manifesto() {
  return (
    <section className="py-24 px-6 relative overflow-hidden" style={{ backgroundColor: '#0D9488' }}>
      {/* Wave decoration top */}
      ...
      <div className="max-w-4xl mx-auto pt-12">
        ...
        <div className="space-y-6 text-2xl md:text-3xl font-light leading-relaxed" style={{ color: 'white' }}>
          ...
          <motion.p className="pt-4" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }}>
            Except one thing.
          </motion.p>
          <motion.p
        ...
        >
          ...
          <Link
            href="/our-story"
            className="inline-block mt-8 text-sm font-bold px-6 py-3 rounded-full transition-all hover:scale-105"
