...
export default function OurStory() {
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden" style={{ backgroundColor: '#E8DFD5' }}>
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <motion.h2
          className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight mb-6 sm:mb-8"
          style={{ color: '#1A1A1A' }}
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        <div className="space-y-4 sm:space-y-6 text-base sm:text-lg leading-relaxed" style={{ color: '#4B5563' }}>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        {/* Founder note */}
        <motion.div
          className="mt-8 sm:mt-12 pt-6 sm:pt-8 flex items-center gap-3 sm:gap-4"
        ...
        >
          <div
            className="w-10 sm:w-12 h-10 sm:h-12 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-base"
            style={{ backgroundColor: '#14B8A6' }}
          >
            M
          </div>
          <div>
            <p className="font-semibold text-sm sm:text-base" style={{ color: '#1A1A1A' }}>Mahesh</p>
            <p className="text-xs sm:text-sm" style={{ color: '#6B7280' }}>Founder, still figuring it out</p>
          </div>
        </motion.div>
      </div>
    </section>
